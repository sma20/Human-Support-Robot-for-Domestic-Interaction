...
action = [[ 'milk', 'get'],[ 'coke', 'get'], [ 'glasses', 'get'], [ 'door', 'check'], [ 'location', 'tell'],[ 'go', 'kitchen'],[ 'go', 'bedroom']]
area = [ 'bedroom', 'living-room', 'bathroom', 'sleeping room', 'kitchen' ]
nouns = []
verbs = []
synonyms = []
task_comb = []
...
if __name__ == '__main__':
    ...
    task_comb = createIntentNounPairs(intents, nouns)
    #print(task_comb)

    for tc in task_comb:
        action = [[ 'kitchen', 'go'][ 'milk', 'get'],[ 'water', 'get'],[ 'coke', 'get'],[ 'snacks', 'get'],[ 'tv-remote', 'get'],[ 'TV', 'turn on'],[ 'Tele Vision', 'turn on'],[ 'LED', 'turn on'],[ 'LCD', 'turn on'],[ 'sounds', 'turn on'],[ 'toaster', 'turn on'],[ 'microwave', 'turn on'],[ 'oven', 'turn on'],[ 'lights', 'turn on'],[ 'newspaper', 'get'], [ 'book', 'get'], [ 'glasses', 'get'], [ 'door', 'check'], [ 'location', 'tell'], [ 'go', 'kitchen'], [ 'go', 'bedroom'],[ 'door', 'get']]
        for a in action:
            if tc[0] == a[0] and tc[1] == a[1]:
                print("do the action " , tc, "from", room)
